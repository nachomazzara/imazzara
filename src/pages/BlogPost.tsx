...
function BlogPost() {
  ...
  const fullTitle = `${post.title} | Nacho Mazzara`
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:site_name" content="Nacho Mazzara" />
        ...
        <meta name="twitter:site" content="@nachomazzara" />
        <meta name="twitter:creator" content="@nachomazzara" />
      </Helmet>
      <div className="blog-container">
        {post.hero && (
